...
- `titleCase(stringToTransform, options)`, applying the headline-style rules of _The Chicago Manual of Style_ 8.159 and 8.161.
- `never`, `always`, and `special` options, matched case-insensitively.
